#--------MODEL----------------
from devnet_model_functions_ebo import *
...
def SANDBOX_INFO(ans1):
    ...
    elif ans1[:2]=="21":url="https://sandboxdnac2.cisco.com/dna/intent/api/"
    elif ans1[:2]=="22":url="https://sandboxdnac.cisco.com/dna/intent/api/"
