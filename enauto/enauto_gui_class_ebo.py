...
from enauto.enauto_gui_iosxe_menus_ebo import *
from enauto.enauto_gui_dnac_menus_ebo import *
from enauto.enauto_gui_sdwan_menus_ebo import *
from enauto.enauto_gui_meraki_menus_ebo import *

#------CONTROLLER---------------------
from enauto.enauto_functions_iosxe_ebo import *
from enauto.enauto_functions_dnac_ebo import *
from enauto.enauto_functions_sdwan_ebo import *
from enauto.enauto_functions_meraki_ebo import *
...
class ENAUTO_MAIN_WINDOW:
    def __init__(self,window):
        ...
        #BOTON FW
        button_fw=tk.Button(window,text="Select",
                fg="black",bg="grey",
                width=5,height=1,
